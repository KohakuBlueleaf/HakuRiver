...
HakuRiver includes an optional web dashboard that provides a graphical interface for monitoring, submitting, and managing tasks.
...
The Tasks section allows submitting, listing, and managing tasks.
