...
.numa-section .resource-title {
  margin-bottom: 10px;
} /* Reuse resource title style */
.numa-section .el-descriptions {
  background-color: var(--el-fill-color-lighter);
} /* Slightly different background for distinction */
.numa-section .el-descriptions__title {
  font-size: 0.9em;
  font-weight: 600;
} /* Smaller title for NUMA node */
.numa-section .code-like {
  /* Style for core list */
