...
from hakuriver.docker.naming import image_tag, task_container_name
from hakuriver.models.requests import TaskStatusUpdate
from hakuriver.runner.config import config
from hakuriver.runner.numa.detector import get_numa_prefix
...
def build_docker_run_command(
    ...
    Args:
        task_id: Task ID.
        docker_image_tag: Full Docker image tag (e.g., "hakuriver/container:base").
