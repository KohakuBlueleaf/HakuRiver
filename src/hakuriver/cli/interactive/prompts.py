...
from hakuriver.cli.formatters.node import format_node_table
...
def interactive_vps_create() -> dict | None:
    ...
    try:
        ...
        if result.get("task_id"):
            from hakuriver.cli.formatters.vps import format_vps_created
            ...
            if ssh_key_mode == "generate" and result.get("ssh_private_key"):
                import os
                from hakuriver.utils.ssh_key import get_default_key_output_path
