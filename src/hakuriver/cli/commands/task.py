...
from hakuriver.cli.output import console, print_error, print_success
    ...
    try:
        ...
        if task_ids:
            ...
            if wait and len(task_ids) == 1:
                from hakuriver.cli.interactive.monitor import wait_for_task
...
def task_logs(
    ...
    try:
        ...
        if follow:
            from hakuriver.cli.interactive.monitor import follow_task_logs
...
def watch_task(
    ...
    try:
        from hakuriver.cli.interactive.monitor import watch_task_status
