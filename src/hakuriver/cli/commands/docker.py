...
from hakuriver.cli.formatters.docker import format_image_table
from hakuriver.cli.output import console, format_bytes, print_error, print_success
...
def migrate_container_cmd(
    ...
    Renames container from '{name}' to 'hakuriver-env-{name}'.
