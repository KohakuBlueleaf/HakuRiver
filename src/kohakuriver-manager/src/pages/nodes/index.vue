...
<template>
  <div class="space-y-6">
    ...
    <!-- Loading -->
    <div v-if="clusterStore.loading && clusterStore.nodes.length === 0" class="text-center py-12">
    ...
    <!-- Cards View -->
    <div v-else-if="viewMode === 'cards'" class="grid-cards">
      <div
      ...
      >
        ...
        <div class="space-y-3">
          ...
          <div>
            ...
            <ResourceBar :value="node.cpu_percent || 0" :max="100" color="auto" :show-percent="false" />
          </div>
          ...
          <!-- Temperature -->
          <div v-if="node.current_avg_temp" class="flex items-center justify-between text-sm">
        ...
        <!-- Expanded Details -->
        <div v-if="expandedNode === node.hostname" class="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
          <!-- NUMA Topology -->
          <div v-if="node.numa_topology" class="mb-3">
        ...
        <tbody>
          <tr v-for="node in clusterStore.nodes" :key="node.hostname" class="table-row">
            ...
            <td class="table-cell">
              <div class="flex items-center gap-2">
                <div class="w-16">
                  <ResourceBar :value="node.cpu_percent || 0" :max="100" size="sm" color="auto" :show-percent="false" />
                </div>
            ...
            <td class="table-cell">
              <span v-if="node.current_avg_temp" :class="node.current_max_temp > 80 ? 'text-red-500' : ''">
