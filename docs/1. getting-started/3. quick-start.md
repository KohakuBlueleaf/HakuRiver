...
VPS tasks provide persistent interactive containers with SSH access.
...
### Connect via WebSocket Terminal

```bash
kohakuriver connect vps <vps_task_id>
```
...
## Step 9: Using the Web Dashboard
